...
api.post('/song', md_auth.ensureAuth, SongsController.saveSong);
api.get('/songs/:album?', md_auth.ensureAuth, SongsController.getSongs);
api.put('/song/:id', md_auth.ensureAuth, SongsController.updateSong);
api.delete('/song/:id', md_auth.ensureAuth, SongsController.deleteSong);
